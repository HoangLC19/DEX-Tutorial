...
contract Exchange is ERC20 {
    ...
    constructor(address _CryptoDevToken) ERC20("CryptoDev LP Token", "CD") {
        require(
        ...
        returns (uint256, uint256)
    {
        ...
        uint256 ethAmount = (ethBalance * _amount) / (_totalSupply);
    ...
    function ethToCryptoDevToken(uint256 _minTokens) public payable {
        ...
        // Transfer the `tokenBought` amount of Crypto Dev tokens from the contract to the user's wallet
    ...
    function cryptoDevTokenToEth(uint256 _tokenSold, uint256 _minEth) public {
        ...
        // Transfer the `_tokenSold` amount of Crypto Dev tokens from the user's wallet to the contract
