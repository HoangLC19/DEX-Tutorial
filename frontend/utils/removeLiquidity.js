...
export const removeLiquidity = async (signer, removeLPTTokenWei) => {
...
export const getTokensAfterRemove = async (
  ...
  try {
    ...
    const _removeCD = cryptoDevReserve.mul(removeLPTokenWei).div(totalSupply);
    return {
        _removeEther,
        _removeCD
    }
